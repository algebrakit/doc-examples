...
<?php
    ...
    $exerciseSpec =  array(
        ...
        'instruction' => 'solve',
        'assignment' => 'Solve[2x^2+5x+15=3-5x,x]',  //the expression to be solved
...
<home>
   ...
   <body>
        <?php
            echo "<akit-derivation session-id='$sessionId' app-id='$appId'></akit-derivation>";
        ?>
